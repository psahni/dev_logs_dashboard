  ...
  return (
    <div>
      <div className="page-header">
        <h1 className="page-title">Standup Generator</h1>
        <p className="page-subtitle">Generate your daily standup from recent activity</p>
      </div>
      ...
      <div className="generator-shell">
        ...
        <div className="generator-output">
          <div className="generator-output-title">Standup</div>
          {error && <div className="error-banner">{error}</div>}
          {!output && !isPending && (
            <div className="generator-placeholder">
              Click Generate to create your standup
            </div>
          )}
          {isPending && (
